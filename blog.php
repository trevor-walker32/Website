        ...
        <div class="w3-content" style="max-width:1400px">
            ...
            <div class="w3-card-4 w3-margin w3-white">
                ...
                <div class="w3-container">
                    <h3><b>A Changing Sport Amongst the Youth</b>  <span class="w3-opacity">Last Updated: July 24, 2018</span></h3>
                    <h5>It's no longer about the sport...</h5>
                    <div class="w3-col m8 s12">
                            <p><a href="ideaOne.php"><button class="w3-button w3-padding-large w3-white w3-border"><b>Read More >></b></button></a></p>
                    </div>
                </div>
            </div>
            <hr>
            ...
            <div class="w3-card-4 w3-margin w3-white">
                <p>Culture</p>
                <div class="w3-container">
                    <h3><b>Starting Good Habits While Athletes Are Young</b>  <span class="w3-opacity">Last Updated: July 24, 2018</span></h3>
                    <h5>If we adopt some ideological changes, we could make a difference... </h5>
                    <div class="w3-col m8 s12">
                            <p><a href="ideaTwo.php"><button class="w3-button w3-padding-large w3-white w3-border"><b>Read More >></b></button></a></p>
                    </div>
                </div>
            </div>
            <hr>
